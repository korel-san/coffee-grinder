...
export let rootFolderId = readEnv('GOOGLE_ROOT_FOLDER_ID') || '1nJnHBcY252xqV0JDIidsxxhJkY6-w2WO'
...
export let templatePresentationId = readEnv('GOOGLE_TEMPLATE_PRESENTATION_ID') || '1Rm5WnQRnEMmw6XDMRIX8l-BZIlt5Sz5CBBtRrzjvpak'
export let templateSlideId = readEnv('GOOGLE_TEMPLATE_SLIDE_ID') || 'p'
export let templateTableId = readEnv('GOOGLE_TEMPLATE_TABLE_ID') || 'g32d1f8c10a8_0_0'
